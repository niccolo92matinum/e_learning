...
class ScormProvider extends Component {
  ...
  closeScormAPIConnection() {
    ...
    const version = SCORM.version;
    version === '1.2' ? SCORM.set('cmi.core.session_time', formattedTime) : SCORM.set('cmi.session_time', getTimeElapsed2004(elapsedSessionSeconds));
...
export const getTimeElapsed2004 = (timeElapsed) => {
    var result;
    if (timeElapsed === 0) {
        result = "PT0S";
    } else {
